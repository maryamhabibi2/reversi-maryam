...
if ((typeof username == 'undefined')|| (username === null) || (username === 'null') || (username === "") ) {
    username = "Anonymouse_"+Math.floor(Math.random()*1000);
}
...
function makeInviteButton(socket_id) {
    ...
    newNode.click( () => {
        ...
        console.log('**** client log message, sneding \'invite\' command:'+JSON.stringify(payload));
...
function makeInvitedButton(socket_id) {
    ...
    newNode.click( () => {
        ...
        console.log('**** client log message, sneding \'uninvite\' command:'+JSON.stringify(payload));
...
function makePlayButton(socket_id) {
    ...
    newNode.click( () => {
        ...
        console.log('**** client log message, sneding \'game_start\' command:'+JSON.stringify(payload));
...
function sendChatMessage(){
    ...
    console.log('**** client log message, sneding \'send_chat_message\'join_room\' command:'+JSON.stringify(request));
...
socket.on('game_update',(payload) =>{
    ...
    if(( typeof board == 'undefined') || (board === null)){
        console.log('Server did not send a valid baord to display');
        return;
    }
    ...
    for (let row = 0; row < 8; row++) {
        for (let column = 0; column < 8; column++) {
            ...
            /*Check to see if the server changed any spaceon the board */
                ...
                if (board[row][column] === ' '){
                    ...
                    $('#' + row + '_'+column).click(((r,c) => {
                        return (() => {
                            ...
                            console.log('**** client log message, sneding \'play_token\' command:'+JSON.stringify(payload));
...
$( () => {
    ...
    request.room = chatRoom;
    request.username = username;
    console.log('**** client log message, sneding \'join_room\' command:'+JSON.stringify(request));
